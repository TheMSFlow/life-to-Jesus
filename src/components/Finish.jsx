          ...
          <section className='flex flex-col justify-center items-center xl:grid xl:grid-cols-[20rem_1fr] xl:h-[30rem] gap-4 w-full xl:max-w-[52.125rem] m-auto py-5 px-4 '>
            ...
            <div>
              ...
              <div className='w-full flex flex-col gap-4 items-center justify-center px-1'>
                {currentStep === 1 && <p className='font-garamond text-2xl md:text-3xl text-center'>Sign in to continue</p>}
                {currentStep === 2 && <p className='font-garamond text-2xl md:text-3xl text-center text-news'>Check your Inbox!</p>}
                <SignInForm onStepChange={setCurrentStep} />
                {/* divider */}
                {currentStep === 1 && (
              <>
                {/* Divider */}
